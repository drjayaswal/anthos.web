...
const buttonVariants = cva(
  "group/button cursor-pointer inline-flex shrink-0 items-center justify-center text-sm border-black/30! whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50  disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        custom_button:
          "bg-transparent! text-foreground border border-dashed border-foreground/50! hover:border-transparent rounded-xl! duration-150!  active:translate-y-0.5",
        custom:
      ...
      color: {
        purple: "bg-linear-to-b from-purple-600 to-purple-700 text-white active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.25)]",
        red: "bg-linear-to-b from-red-600 to-red-700 text-white active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.25)]",
        yellow: "bg-linear-to-b from-yellow-600 to-yellow-700 text-white active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.25)]",
        amber: "bg-linear-to-b from-amber-600 to-amber-700 text-white active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.25)]",
