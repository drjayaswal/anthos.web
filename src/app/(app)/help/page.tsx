  ...
  return (
    <div className="min-h-0 text-foreground">
      <main className="max-w-4xl sm:mt-0 sm:mx-auto mt-10 mx-2 px-4 sm:px-6 py-4 sm:py-8 space-y-6 sm:space-y-8">
        <div className="flex flex-row items-center justify-between gap-3 border-b border-dashed border-foreground/30 pb-4 sm:pb-5">
          <div className="space-y-0.5 min-w-0">
            ...
            <p className="text-xs text-foreground/50 sm:text-sm truncate">
            ...
            {guides.map((guide, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-2 text-foreground space-y-1"
                >
